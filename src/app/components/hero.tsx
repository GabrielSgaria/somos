    ...
    return (
        <section className="w-full min-h-[750px] md:max-h-[1080px] xl:max-h-[780px] 2xl:min-h-[918px] bg-no-repeat bg-cover bg-right-top md:bg-top bg-mobile md:bg-desktop flex justify-center items-center xl:justify-start xl:pl-48 mb-20 relative">
            ...
            >
                ...
                <span className="font-light text-xl -mt-5 md:-mt-10 text-gray-50 text-center">
                    SOMOS UM ESTILO DE HOSPEDAGEM FOCADO EM DESIGN, SERVIÇO E EXPERIÊNCIA
                </span>
                <button
                    onClick={() => sendMensage()}
                    className="font-bold px-8 py-2 rounded-full bg-gradient-to-b from-blue-500 to-blue-600 text-white focus:ring-2 focus:ring-blue-400 hover:shadow-xl transition duration-200"
                >
                    Saiba Mais
                </button>
            </motion.div>
